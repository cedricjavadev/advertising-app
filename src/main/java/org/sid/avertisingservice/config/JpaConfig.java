...
@EnableJpaRepositories(basePackages = {"org.sid.avertisingservice.config","org.sid.avertisingservice.repository"})
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        em.setPackagesToScan("org.sid.avertisingservice.entities");
